...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Join with us to get the help from Anywhere">
    <meta name="author" content="">
    <meta name="generator" content="is">
    <title>Probashi Plus | Admin</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:description" content="Join with us to get the help from Anywhere">
    <meta name="twitter:image" content="images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="dashboard.html">
    <meta property="og:title" content="Dashboard">
    <meta property="og:description" content="Join with us to get the help from Anywhere">
  ...
  <body>
    <div class="wrapper dashboard-wrapper">
      <div class="d-flex flex-wrap flex-xl-nowrap">
        <div class="db-sidebar bg-white z-20">
          <nav class="navbar navbar-expand-xl navbar-light d-block px-0 header-sticky dashboard-nav py-0">
            <div class="sticky-area shadow-xs-1 py-3">
              <div class="d-flex px-3 px-xl-6 w-100">
                <a class="navbar-brand" href="/">
                  <img src="{{asset('logo.png')}}" alt="ProbashiPlusLogo">
                </a>
                  ...
                  <div class="d-flex align-items-center d-xl-none">
                    <div class="dropdown px-3">
                      <a href="#" class="dropdown-toggle d-flex align-items-center text-heading"
                        ...
                        <div class="w-48px">
                            <img src="{{ auth()->user()->photo ? asset('images/' . auth()->user()->photo) : asset('profile.png') }}" alt="{{ auth()->user()->name }}" class="rounded-circle">
                        </div>
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('user.bookings.index')}}">My Packages</a>
                ...
                <ul class="list-group list-group-flush w-100">
                  <li class="list-group-item">
                    ...
                    <ul class="list-group list-group-no-border rounded-lg">
                      @role('Super Admin|Admin')
                      @can('dashboard')
                      <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item" role="button" onclick="window.location='{{ route('dashboard') }}'">
                        <a href="{{route('dashboard')}}" class="text-heading lh-1 sidebar-link">
                          <span class="sidebar-item-icon d-inline-block mr-3 fs-20"><i class="fad fa-chart-line"></i></span>
                      ...
                      @endrole
                      @can('package')
                      <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item" role="button" onclick="window.location='{{ route('admin.packages') }}'" >
                        <a href="{{route('admin.packages')}}" class="text-heading lh-1 sidebar-link">
                          <span class="sidebar-item-icon d-inline-block mr-3 fs-20"><i class="fad fa-box-check"></i></span>
                          <span class="sidebar-item-text">Packages</span>
                        </a>
                      </li>
                      @endcan
                      @can('booking')
                      <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item" role="button" onclick="window.location='{{ route('admin.bookings.index') }}'" >
                        <a href="{{route('admin.bookings.index')}}" class="text-heading lh-1 sidebar-link">
                          <span class="sidebar-item-icon d-inline-block mr-3 fs-20"><i class="fad fa-folder-download"></i></span>
                          <span class="sidebar-item-text">Bookings</span>
                        </a>
                      </li>
                      @endcan
                      @can('user')
                      <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item" role="button" onclick="window.location='{{ route('users.manage') }}'" >
                        <a href="{{route('users.manage')}}" class="text-heading lh-1 sidebar-link">
                          <span class="sidebar-item-icon d-inline-block mr-3 fs-20"><i class="fad fa-users"></i></span>
                ...
                <li class="list-group-item">
                    ...
                    <ul class="list-group list-group-no-border rounded-lg">
                        ...
                        <div class="collapse" id="package_collapse">
                            ...
                            <ul class="list-group list-group-flush list-group-no-border">
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item"  role="button" onclick="window.location='{{ route('countries') }}'">
                                    <a class="text-heading lh-1 sidebar-link" href="{{ route('countries') }}">Country</a>
                                </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item"  role="button" onclick="window.location='{{ route('cities') }}'">
                                    <a class="text-heading lh-1 sidebar-link" href="{{route('cities')}}">City</a>
                                </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item"  role="button" onclick="window.location='{{ route('areas') }}'">
                                    <a class="text-heading lh-1 sidebar-link" href="{{route('areas')}}">Service Area</a>
                                </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item"  role="button" onclick="window.location='{{ route('property-types') }}'">
                                    <a class="text-heading lh-1 sidebar-link" href="{{route('property-types')}}">Area Property Type</a>
                                </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item"  role="button" onclick="window.location='{{ route('properties') }}'">
                                    <a class="text-heading lh-1 sidebar-link" href="{{route('properties')}}">Services</a>
                                </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item"  role="button" onclick="window.location='{{ route('maintain-type') }}'">
                                    <a class="text-heading lh-1 sidebar-link" href="{{route('maintain-type')}}">Gold Benefits Type</a>
                                </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item"  role="button" onclick="window.location='{{ route('maintain') }}'">
                                    <a class="text-heading lh-1 sidebar-link" href="{{route('maintain')}}">Amenity</a>
                                </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item"  role="button" onclick="window.location='{{ route('amenity-type') }}'">
                                    <a class="text-heading lh-1 sidebar-link" href="{{route('amenity-type')}}">Silver Benefits Type</a>
                                </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item"  role="button" onclick="window.location='{{ route('amenities') }}'">
                                    <a class="text-heading lh-1 sidebar-link" href="{{route('amenities')}}">Silver Benefits</a>
                                </li>
                            </ul>
                            </div>
                        </div>
                    ...
                    <ul class="list-group list-group-no-border rounded-lg">
                        ...
                        <div class="collapse" id="roles_collapse">
                            ...
                            <ul class="list-group list-group-flush list-group-no-border">
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('roles')}}">Roles</a>
                                </li>
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                ...
                                <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('users')}}">Assign Role</a>
                                </li>
                            </ul>
                            </div>
                        </div>
                    ...
                    <ul class="list-group list-group-no-border rounded-lg">
                      ...
                      <div class="collapse" id="sites_collapse">
                          ...
                          <ul class="list-group list-group-flush list-group-no-border">
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('logo')}}">Header</a>
                              </li>
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link"href="{{route('hero-section')}}">Hero Section</a>
                              </li>
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('home-data')}}">Home Data</a>
                              </li>
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('admin.privacy-policy')}}">Privacy Policy</a>
                              </li>
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('admin-terms-condition')}}">User Terms & Condition</a>
                              </li>
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('admin-partner-terms-condition')}}">Partner Terms & Condition</a>                              </li>
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('footer-main')}}">Footer 1</a>
                              </li>
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('footer-two')}}">Footer 2</a>
                              </li>
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('footer-three')}}">Footer 3</a>
                              </li>
                              <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                <a class="text-heading lh-1 sidebar-link" href="{{route('footer-four')}}">Footer 4</a>
                              </li>
                          </ul>
                          </div>
                      </div>
                    ...
                    <ul class="list-group list-group-no-border rounded-lg">
                        ...
                        <li class="list-group-item sidebar-item">
                            ...
                            <span class="sidebar-item-number ml-auto text-primary fs-15 font-weight-bold">
                                @php
                                    $bookingCount = App\Models\Booking::where('user_id', Auth::id())->count();
                                    echo $bookingCount;
                                @endphp
                            </span>
                            </a>
                      ...
                      <li class="list-group-item mt-2 px-3 px-xl-4 py-2 sidebar-item">
                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="text-heading lh-1 sidebar-link">
                          <span class="sidebar-item-icon d-inline-block mr-3 text-muted fs-20">
        ...
        <div class="page-content">
          ...
          <main id="content" class="pb-4 m-4">
                {{$slot}}
          </main>
        </div>
      </div>
