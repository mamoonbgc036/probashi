...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Probashi Plus Services">
    <meta name="author" content="">
    <meta name="generator" content="Jekyll">
    <title>Probashi Plus</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:title" content="Join with us to get the help from Anywhere">
    <meta name="twitter:description" content="Probashi Plus Services">
    <meta name="twitter:image" content="images/homeid-social-logo.png">
    
    <!-- Facebook -->
    <meta property="og:title" content="Join with us to get the help from Anywhere">
    <meta property="og:description" content="Probashi Plus Services">
          ...
          <nav class="navbar navbar-expand-lg px-0">
            <div class="container-fluid">
                ...
                <div >
                    ...
                    @else
                    <a class="nav-link px-2 text-dark hover-s" data-toggle="modal" href="#signInModal">SIGN IN</a>
                    <a class="nav-link px-2 text-dark hover-s" data-toggle="modal" href="#signUpModal">SIGN UP
                    </a>
                    @endif
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                ...
                checkboxes.forEach(cb => {
                    if (cb.checked) {
                        selectedRooms.push(cb.nextElementSibling.textContent.trim());
                    }
                });
                dropdownButton.textContent = selectedRooms.length ? selectedRooms.join(', ') : 'Select Rooms';
            });
        });
    });
</script>
      ...
      {{-- <div class="modal fade login-register login-register-modal" id="login-register-modal" tabindex="-1" role="dialog"
       aria-labelledby="login-register-modal" aria-hidden="true">
        @livewire('user.registration-component')
      </div> --}}

      <div class="modal fade" id="signInModal" tabindex="-1" role="dialog" aria-labelledby="signInModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                @livewire('user.login-component')
            </div>
        </div>
    </div>
...
<div id="whatsapp-popup" class="whatsapp-popup">
  <div class="popup-header">Hi there!</div>
  <div class="popup-content">Need help? Click below to start a chat with us.</div>
  <a href="https://wa.me/+0044771319672" target="_blank" class="popup-button">Chat Now</a>
</div>    
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
      ...
      }, 2000); // Adjust the delay before showing the pop-up
  });
</script>
    </body>
  </html>
